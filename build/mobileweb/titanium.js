...
var require = {
	app: {
		...
		description: "相合傘プロジェクト",
		guid: "3f4f1939-c86b-4ae5-8e92-1a06bb9f955d",
		id: "com.apluplu.aiai",
		name: "AIAI",
		names: {},
		publisher: "hajime",
...
require("Ti/App/Properties", function(p) {
	p.setString("acs-oauth-secret-development","SQe4QAwc2GRw4ajM0U1pNeItANjmoQbx");
	p.setString("acs-oauth-key-development","pxa1fKVxVIJ4PLQgoDzhrhx4T2moYLAm");
	p.setString("acs-api-key-development","O48nLnNTyW4XUASW84dTTXfjrX1UB9Cu");
	p.setString("acs-oauth-secret-production","aRtUHbTDJGB9tvWQ4J93SWlaN3sCl9GQ");
	p.setString("acs-oauth-key-production","PdcPFgAzNy05x0PzYa0CqzUiy1tSFSXw");
	p.setString("acs-api-key-production","ocNKDnUWv33asdUnybmZhCkyEbl01hzK");
